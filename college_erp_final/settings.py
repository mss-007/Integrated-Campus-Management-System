"""
Django settings for college_erp_final project.
...
SECRET_KEY = 'django-insecure-(osx4tm*#s#l&q@jaa%sdynq*t=qczp8y4#@e$^1&o(^9us7n1'
...
WSGI_APPLICATION = 'college_erp_final.wsgi.application'
